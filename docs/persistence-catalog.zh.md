...
来源：[`packages/shell/shell-command/src/types.ts:71`](../packages/shell/shell-command/src/types.ts)
...
来源：[`packages/shell/shell-command/src/types.ts:57`](../packages/shell/shell-command/src/types.ts)
