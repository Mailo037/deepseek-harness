...
describe('release families', () => {
  it('excludes private experimental packages and the Android deployment app from the dsh release', () => {
    ...
    expect(members.map(member => member.name)).not.toContain('@deepseek-ai/dsh-android')
  })
