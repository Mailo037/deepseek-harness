...
- **Non-image draft cards are plain chips** — text and workspace-file attachments render as a static document chip; DeepSeek Chat-style file cards, upload-progress states, and preview/download exist only for images, and there is no history renderer for non-image files yet.
