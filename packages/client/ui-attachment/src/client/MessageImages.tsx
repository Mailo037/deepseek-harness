...
export function MessageImages({ images, loadImage, align, variant, t }: MessageImagesProps) {
  return <ImageGallery images={images} load={loadImage} align={align} variant={variant} labels={messageImageLabels(t)} />
}
