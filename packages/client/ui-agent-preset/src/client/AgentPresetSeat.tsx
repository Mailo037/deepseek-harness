...
import { ElevatorLabel, IconAgentPresetOutline16, IconChevronDownOutline14, Menu } from '@deepseek-ai/dsh-client-ui-primitives'
    ...
    <Menu
      ...
      anchor={(
        ...
        >
          ...
          {introducing ? shownLabel : <ElevatorLabel value={label} />}
