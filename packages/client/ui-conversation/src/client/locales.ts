...
export const zh = {
  ...
  'file.restore': '将 {name} 放回输入框',
  'file.commandUnsupported': '命令仅支持图片附件',
  'file.attachFailed': '添加 {name} 失败：{message}',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  ...
  'tool.readImage': '查看图片',
  'tool.image.showInfo': '信息',
  'tool.image.hideInfo': '隐藏信息',
  ...
  'stats.edits': '{files} 个文件 · +{linesAdded} · -{linesRemoved}',
  ...
  'message.turnError.details': '详情',
  'message.turnError.hideDetails': '隐藏详情',
  'message.turnError.detail.code': '错误码：',
  'message.turnError.detail.status': 'HTTP 状态：',
  'message.turnError.detail.requestId': '请求 ID：',
  'message.turnError.detail.message': '详细信息：',
  'message.turnError.retryMessage': '发生意外错误，请继续你之前的工作。',
  ...
  'web.emptySearch': '未找到结果',
  'web.sourcesTruncated': '来源列表已截断',
  'web.contentTruncated': '内容已截断',
  'status.dive.0': '正在深海下潜…',
  'status.dive.1': '追那头任务鲸…',
  'status.dive.2': '跟着鲨群走…',
  'status.dive.3': '回声定位中…',
  'status.dive.4': '吹一串泡泡…',
  'status.dive.5': '漂过沉船…',
...
export const en = {
  ...
  'input.add': 'Add attachment',
  'input.uploadFile': 'Upload file',
  'file.remove': 'Remove file {name}',
  'file.restore': 'Put {name} back into the input',
  'file.commandUnsupported': 'Commands accept image attachments only',
  'file.attachFailed': 'Adding {name} failed: {message}',
  ...
  'tool.image.showInfo': 'Info',
  'tool.image.hideInfo': 'Hide info',
  ...
  'stats.edits': '{files} files · +{linesAdded} · -{linesRemoved}',
  ...
  'hero.noWorkspace': 'No workspace',
  'session.hierarchy': 'Session hierarchy',
  'session.blank': 'No session',
  ...
  'message.turnError.details': 'Details',
  'message.turnError.hideDetails': 'Hide details',
  'message.turnError.detail.code': 'Code: ',
  'message.turnError.detail.status': 'HTTP Status: ',
  'message.turnError.detail.requestId': 'Request ID: ',
  'message.turnError.detail.message': 'Message: ',
  'message.turnError.retryMessage': 'An unexpected error occurred, please continue what you were doing.',
  ...
  'message.tokensPerSecond': '{tps} tok/s',
  'toolGroup.editedFiles': 'edited files',
  ...
  'queue.reorder': 'Drag to reorder queued messages',
  ...
  'queue.editing': 'Editing queued message: Enter to save in place and restore draft, Esc to cancel',
  ...
  'queue.moveFailed': 'Move failed: this message may have already started sending.',
  ...
  'search.expandAria': 'Expand the remaining {n} result rows',
  'search.expandRest': '… {n} more lines',
  'web.emptySearch': 'No results found',
  'web.sourcesTruncated': 'Source list truncated',
  'web.contentTruncated': 'Content truncated',
  'status.dive.0': 'Deep diving...',
  'status.dive.1': 'Chasing the task whale...',
  'status.dive.2': 'Following the sharks...',
  'status.dive.3': 'Echo-locating...',
  'status.dive.4': 'Blowing bubbles...',
  'status.dive.5': 'Past the wreck...',
  'status.dive.6': 'Whale on the way...',
  'status.dive.7': 'A bit salty...',
  'status.dive.8': 'Chasing the narwhal horn...',
  'status.dive.9': 'Meeting the sharks...',
  'status.backgroundJobs': 'Background tasks running...',
  'clock.md': '{m}/{d}',
  'clock.ymd': '{y}-{m}-{d}',
