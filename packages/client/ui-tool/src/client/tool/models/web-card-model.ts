...
/**
 * Build the {@link WebBlock} display copy from the conversation locale seat —
 * the one place the primitive's label surface pairs with this package's
 * dictionary, shared by every web render site (chat row, web row, details
 * panel).
