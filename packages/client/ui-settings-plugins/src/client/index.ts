...
import { WEB_SEARCH_NS, WEB_SEARCH_SELECT_NS, WebSearchCardController } from './web-search-card-controller.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  const webSearch = new WebSearchCardController(
    ...
    ctx.settingsScope.bind({ namespace: WEB_SEARCH_SELECT_NS }),
    api,
  )
