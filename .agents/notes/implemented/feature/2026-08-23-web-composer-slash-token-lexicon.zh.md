...
这是对明文引用决策（[web input machine and slash pipeline](../architecture/2026-07-25-web-input-machine-and-slash-pipeline.md)）的扩展，不改变任何序列化：pick 仍落地字面文本，提示词发出的也是同一段字面文本。
